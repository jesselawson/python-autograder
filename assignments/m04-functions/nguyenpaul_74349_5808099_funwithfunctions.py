...
Note:  This is ambiguous since a string cannot be equal to the contents of the first argument and equal to the contents of the second argument without those being the same.
"""
...
def calculate_shipping_costs(total_packages, total_weight):
	return (total_packages*12.50) if total_weight < 50 else (total_packages*19.75)
