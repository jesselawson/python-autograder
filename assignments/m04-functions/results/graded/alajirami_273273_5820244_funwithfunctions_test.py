...
"""
def is_spam(subject):
  if "greeting" in subject or "Re:" in subject or "Fwd:" in subject or "Coupons" in subject or"Special Offer !" in subject:
...
* Test #1 FAILED: string_compare() failed before test due to a TypeError: string_compare() missing 1 required positional argument: 'b'
