...
def is_spam(subject):
    if (type(subject.find("Greeting , ")) is int) and subject.find("Greeting , ")!=-1  :  #could also use ("Greeting , " in subject)
        return True
    elif (type(subject.find("Re: Fwd: Coupons")) is int) and subject.find("Re: Fwd: Coupons")!=-1:
        return True
    elif (type(subject.find("Special Offer !")) is int) and subject.find("Special Offer !")!=-1:
        return True
    else:
        return False
        
is_spam("hello, my name is jack.")
...
Compiled: 25-Feb-2020
  ...
  File "m04-functions/results/nglenora_70272_5830231_funwithfunctions_test.py", line 136
    (25-Feb-2020 Professor Lawson) Below you will find all the test 
                 ^
