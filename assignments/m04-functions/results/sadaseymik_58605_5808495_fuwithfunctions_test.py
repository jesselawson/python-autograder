...
Purple
Blue
The cost of shipping is 98.75. 
The cost of shipping is 62.5. 
* Test #1 FAILED: string_compare() failed before test due to a TypeError: string_compare() missing 1 required positional argument: 'secondString'
