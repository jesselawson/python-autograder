...
# The class LogSentry will parse a directory of log files in the following format:
...
class LogSentry:
    ...
    def parse(self):
        """
        Primary function of LogSentry objects. This parses self.filename 
...
def main():
    ...
    parser = LogSentry("traffic_logs.txt", 0.35) # Parse file "traffic_logs.txt" with 35% sensitivity
